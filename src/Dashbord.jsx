...
function Dashbord() {
  ...
  useEffect(() => {
    fetch(
      `http://api.weatherapi.com/v1/forecast.json?key=5a5bc2daa49a42e98b5130421251702&q=${location.lat},${location.lon}&days=5&aqi=no&alerts=no`
    )
      ...
      <div className="row d-flex justify-content-around p-2">
        ...
        <div className="col-xl-8 col-sm-12 day_info d-flex justify-content-center text-center">
          ...
          <div className="col-xl-4 col-sm-12 second_data text-center">
            ...
            <p className="condition_text text-center">
          ...
          <div className="col-xl-4 col-sm-12">
            ...
            <div className="d-flex justify-content-around mt-1">
              <div className="humidity pt-3">
                <img src={img5} alt="" />
                <p className="humidity_text m-0">
                  <b>{data.current.pressure_mb} mb</b>
                </p>
          ...
          <div className="col-3 forcast_1">
            ...
            <div className="row">
              {data.forecast.forecastday.map((day, index) => (
                <div
                  key={index}
                  className="text-center d-flex gap-1 m-0 align-items-center"
                >
                  <div className="col-4 day_forecast">
                    <b>{day.date}</b>
                  </div>
                  <div className="col-4 day_forecast">
                  ...
                  <div className="col-4 day_forecast">
                    {(day.day.maxtemp_c + day.day.mintemp_c) / 2}°C
                  </div>
                </div>
              ))}
            </div>
